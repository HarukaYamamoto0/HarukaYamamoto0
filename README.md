...
- **[Whitelist Caller](https://github.com/HarukaYamamoto0/whitelist-caller)** — A call blocker that follows the [KISS](en.wikipedia.org/wiki/KISS_principle) principle.
